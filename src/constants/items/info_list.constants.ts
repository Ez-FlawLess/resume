        ...
        list: [
            {
                ...
                works: [
                    ...
                    "Came up with a fast algorithm for searching words in text in a way that it could be used to check chat messages in gaming streaming websites using typescript",
            ...
            },
            {
                ...
                works: [
                    ...
                    "Created a React library named flawless-ui to speed up development for company projects and published to NPM",
