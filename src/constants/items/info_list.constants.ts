...
export const INFO_LIST: InfoI[] = [
  {
    ...
    list: [
      {
        title: "Senior Front End Developer, WeCodeRight, Netherlands",
        from: "November 2023",
        to: "March 2025",
        works: [
          "Work from home",
      ...
      {
        title: "Senior Front End Developer, HiWEB, Tehran",
        from: "January 2021",
        to: "September 2023",
        works: [
  ...
  },
  {
    ...
    list: [
      {
        title:
          "Computer Science, Islamic Azad University, Central Tehran Branch, Tehran",
        from: "",
        to: "",
        works: [],
      },
